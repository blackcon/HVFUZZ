...
struct vmscsi_win8_extension {
	 ...
	 */
	unsigned __int16 reserve;		// 2
	unsigned __int8  queue_tag;		// 1
	unsigned __int8  queue_action;	// 1
	unsigned __int32 srb_flags;		// 4
	unsigned __int32 time_out_value; // 4
	unsigned __int32 queue_sort_ey;	// 4
};
...
struct vmscsi_request {
	 ...
	 */
	struct vmscsi_win8_extension win8_extension;	// size: 0x10
};
